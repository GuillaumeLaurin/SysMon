<#
.SYNOPSIS
    Exports the SysMon self-signed certificate as a base64-encoded PFX
...
.PARAMETER CertSubject
    Subject of the certificate to export (default: CN=SysMon).
...
$tmpPfx = Join-Path $env:TEMP "sysmon-export-$([System.IO.Path]::GetRandomFileName()).pfx"
